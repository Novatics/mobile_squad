...
class GlitterAnimation extends StatefulWidget {
  GlitterAnimation({ Key key }) : super(key : key);

  @override
  GlitterWidget createState() => GlitterWidget();
}

class GlitterWidget extends State<GlitterAnimation> with TickerProviderStateMixin {
